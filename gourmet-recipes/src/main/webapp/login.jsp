...
<body>
  <div>
      ...
      <aside class="col-sm-4">
        <div class="card border-warning">
          <article class="card-body">
            ...
            <h4 class="card-title mb-4 mt-2 p-2">SIGN IN</h4>
            ...
            <form action="userLogin" method="post" onsubmit="return validateForm()">
              ...
              <div class="mb-3">
                <a href="validateEmail" class="float-end">Forgot?</a>
            ...
            <div class="text-center">
              <p>Not a member ? <a href="registerUser">Sign up</a></p>
            </div>
          </article>
        </div>
      </aside>
    ...
    <!-- footer section -->
    <footer class="footer_section mt-4">
      <div class="container-fluid">
