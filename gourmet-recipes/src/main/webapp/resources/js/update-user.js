function validateFName() {
  ...
  function validateEmail() {
    ...
    let emailEle2 = document.getElementById("user-email").value.trim();
  ...
  function validateContactNo() {
    ...
    let contactEle2 = document.getElementById("user-contactNo").value.trim();
  ...
  function checkEmail() {
    ...
    ajaxRequest.open("GET", "http://localhost:8080/Food-Recipe/rest/checkEmailExcept?userEmail="+email+"&userId="+userId, false);
    ajaxRequest.send();
  ...
  function checkContactNo() {
    ...
    ajaxRequest.open(
      "GET",
      "http://localhost:8080/Food-Recipe/rest/checkContactNoExcept?contactNo=" +
      contactNo+"&userId="+userId,
      false
    );
    ajaxRequest.send();
    let ajaxResponse = ajaxRequest.responseText;
