...
<body>
  ...
  <!-- login section -->
  <div class="login-section mt-2 mb-2">
        ...
        <article class="card-body">
          ...
          <form action="changePassword" method="post" onsubmit="return validateChangePassword()">
            <div class="user-details">
              <input class="form-control d-none" type="text" name="uid" id="id" value="${currentUser.getId()}" />
              <div class="input-box my-2 p-2">
  ...
  <!-- footer section -->
  <footer class="footer_section" style="top: 3vh">
    <div class="container-fluid">
